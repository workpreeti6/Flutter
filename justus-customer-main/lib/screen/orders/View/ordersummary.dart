...
class OrderSummary extends StatelessWidget {
  OrderSummary({Key? key, this.ind}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    final args = ModalRoute.of(context)!.settings.arguments as OrderSummary;
    final ordersdata = OrdersList().orderslist[args.ind!];
    return Scaffold(
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text("4 Days from the date of pick up",
                                  style: GoogleFonts.varelaRound(
                                    fontSize: 14,
                                  )),
                              // SizedBox(width: 5,)
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text(
                                "2 Days from the date of pick up",
                                style: GoogleFonts.varelaRound(
                                  fontSize: 14,
                                ),
                              ),
